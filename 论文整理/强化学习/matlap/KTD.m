function model = KTD(X,r,param)
    ...
    % Kalman temporal difference learning model  Kalman的时间差异学习模型
    %
    ...
    for n = 1:N
        ...
        h = X(n,:) - g*X(n+1,:);    % temporal difference features时间差异特征
        V = X(n,:)*w;               % value estimate 价值估计
